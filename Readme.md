...
* ### [Installing Oh-My-Zsh](./guide/zsh.md)
    * #### [Run the Installer](./guide/zsh.md#Run-the-Installer)
    * #### [Getting the plugins](./guide/zsh.md#Getting-the-plugins)
    * #### [Adding the plugins to .zshrc](./guide/zsh.md#Adding-the-plugins-to-.zshrc)
    * #### [Adding powerlevel10k](./guide/zsh.md#Adding-powerlevel10k)
    * #### [Styling ls & la](./guide/zsh.md#Styling-ls-&-la)
    * #### [Adding ruby-colorls to .zshrc](./guide/zsh.md#Adding-ruby-colorls-to-.zshrc)
